...
def _check_fn_cached(fn: Callable) -> bool:
    ...
    with _check_fn_cache_lock:
        ...
        # merge: upstream's block kept — identical INFO/WARNING selector to local, plus the
        # once-per-process WARNING when a previously-available core tool's probe now fails
        # (#112649); the local side had no core-drop branch at all.
