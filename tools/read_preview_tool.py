...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "When more than one preview is mounted, the JSON also includes active_tab_id and tabs "
        "[{id, kind, label, url}] for the hovered or focused zone, not a stale "
        "global tab. A URL (Browser) tab's text is the rendered page's visible text — page "
