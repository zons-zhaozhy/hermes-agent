...
_TOOL_STUBS = {
    ...
    "write_file": ("path: str, content: str, cross_profile: bool = False, expected_fingerprint: str = None",
        '"""Write content to a file (always overwrites). Returns dict with status."""',
        '{"path": path, "content": content, "cross_profile": cross_profile, "expected_fingerprint": expected_fingerprint}'),
    ...
    "patch": ('path: str = None, old_string: str = None, new_string: str = None, replace_all: bool = False, mode: str = "replace", patch: str = None, cross_profile: bool = False, expected_fingerprint: str = None',
        '"""Targeted find-and-replace (mode="replace") or V4A multi-file patches (mode="patch"). Returns dict with status."""',
        '{"path": path, "old_string": old_string, "new_string": new_string, "replace_all": replace_all, "mode": mode, "patch": patch, "cross_profile": cross_profile, "expected_fingerprint": expected_fingerprint}'),
