...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "WHEN TO USE: bounded mechanical tasks (i18n keys, file transforms, "
        "targeted search/replace); parallel independent work; reasoning "
        "subtasks with fully self-contained context.\n\n"
        "WHEN NOT TO USE: tasks needing codegraph/gitnexus, skill knowledge, "
        "project conventions, or memory -> do these yourself via "
        "execute_code; a single tool call -> call it directly; tasks "
        "needing user interaction (subagents lack clarify/memory); durable "
        ...
        "- Subagents have NO memory/skills/conventions — pass everything "
        "via 'context'. Load relevant skills first, embed key rules.\n"
