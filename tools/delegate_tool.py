...
_DESCRIPTION_HEAD = (
    ...
    "child drifting.\n\n"
    "DECOMPOSITION: split a complex goal into independent subtasks small enough to solve reliably; tasks within one "
    "batch run CONCURRENTLY, so anything where a later step needs an earlier step's result must be separate sequential "
    "delegate_task calls — solve easy stages first and feed their results (via 'context') into the harder ones.\n"
