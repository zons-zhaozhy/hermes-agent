...
def test_add_contributor_refuses_a_case_collision(tmp_path, monkeypatch):
    ...
    # Case-insensitive filesystems (macOS/Windows default) resolve both
    # spellings to one file, so exists() can't discriminate — the invariant
    # is that NO second entry was created.
