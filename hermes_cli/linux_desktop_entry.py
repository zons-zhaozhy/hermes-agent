...
def _needs_interpreter(bin_path: Path) -> bool:
    ...
    # Compare lowercased on BOTH sides: the shebang above was lowercased,
    # and macOS paths can contain uppercase (e.g. homebrew's
    # ``.../Frameworks/Python.framework/...``) — a one-sided lower made every
    # venv-shebang launcher on such installs look non-venv.
