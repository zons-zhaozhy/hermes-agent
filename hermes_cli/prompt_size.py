...
def _find_skills_block(text: str):
    """Find <available_skills>...</available_skills> block. O(n) scan — replaces the
    earlier DOTALL regex whose lazy repetition risked backtracking blowups (# perf,
    fork commit eb0775d15e)."""
    if not text:
        return None
