...
class SessionManager:
    ...
    def _make_agent(self, *, session_id: str, cwd: str, model: str | None = None,
        ...
        # merge: kept upstream's error surfacing; the `agent.session_cwd = cwd` stamp stays dropped —
        # local routes the ACP workspace through agent.runtime_cwd.set_session_cwd.
        try:
