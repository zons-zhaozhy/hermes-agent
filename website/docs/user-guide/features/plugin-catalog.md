...
<!-- merge: both sides added a paragraph here — upstream's onboarding note kept first, then the local "Published browse data" section (it heads its own h3 and must not be swallowed by the paragraph). -->
